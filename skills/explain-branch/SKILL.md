...
2. **One chapter per substantial commit**, in build order, `id: "chapter-N"`, heading titled
   ...
   mandatory", not "Chapter 2: d157b1d". Give the section a `"commit"` field — e.g.
   `{"hash": "d157b1d", "subject": "refactor(PP3-285): make x-cu-method explicit, skip fields without one", "url": ..., "diffstat": {...}}`
