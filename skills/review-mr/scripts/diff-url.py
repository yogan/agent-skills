...
with rework-mr's own copy of this file (there is no per-skill logic here at all)."""
import os
import sys

# Repo root, 4 levels up from skills/review-mr/scripts/diff-url.py — needed so `lib/`,
